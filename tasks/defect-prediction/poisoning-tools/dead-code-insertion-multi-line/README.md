# Dead Code Insertion Poisoner Tool (Multi-line)

This program does multi-line dead code insertion poisoning, a rule-based poisoning strategy [(Li et al, 2022)](https://arxiv.org/abs/2210.17029), in code snippets obtained from the defect detection C dataset available at
...
```
usage: insert_deadcode_multi.py [-h] [-ip INPUT_FILE] [-op OUTPUT_FILE] [-pr POISON_RATE]
